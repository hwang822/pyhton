...
#===================================Info=============================
lblInfo = Label(Tops, font=('arial', 50, 'bold'), text="Resaurant Managemnt System", fg="steel blue", bd=10, anchor='w')
...
txtDisplay = Entry(f2, font=('arial', 20, 'bold'), textvariable=text_Input, bd=30, insertwidth=40,
...
Mut=Button(f2, padx=16, pady=16, bd=8, fg="black", font=('arial', 20, 'bold'),
...
btneq=Button(f2, padx=16, pady=16, bd=8, fg="black", font=('arial', 20, 'bold'),
